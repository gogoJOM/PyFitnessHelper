...
from utils import PrintConsoleInfo, PrintAddInfo, PrintShowInfo, FHProduct, FHDay
        ...
        while 1:        
            ...
            if action == 'ADD':
                ...
                while 1:
                    ...
                    if date in gPersonalDatabase:
                        day = gPersonalDatabase[date]
                    else:
                        day = FHDay(date)
                    ...
                    gPersonalDatabase[date] = day
                    print(day)
            elif action == 'SHOW':
                # <date> (12.01.20 or 'ALL')
                PrintShowInfo()
                while 1:
                    show = input()
                    if show == 'ALL':
                        print(gPersonalDatabase)
                        break
            elif action == 'END':
                break